...
const PosterCard = ({ src, title, genre }) => {
  const limitTitle = (name, limit = 17) => { // a function to reduce the title if it has more than 17 character with convert the string into an array to use the reduce method on it and join it back to a string again
  const newTitle = []

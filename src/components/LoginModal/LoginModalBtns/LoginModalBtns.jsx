...
import classes from './LoginModalBtns.module.css';
import LoginModal from '../LoginModal';

const LoginModalTabs = ({ clicked, children, active }) => {
  // signActive and loginActive to show which tab is active
  const signActive = active === 'Sign Up' ? [classes.ModalTabsButton, classes.active].join(' ') : classes.ModalTabsButton;
  const loginActive = active === 'Log In' ? [classes.ModalTabsButton, classes.active].join(' ') : classes.ModalTabsButton;
  return (
